...
namespace midTerm.Controllers
{
    ...
    public class AnswersController : ControllerBase
    {
        ...
        [HttpGet("/Answers/{id:int}", Name = nameof(Get))]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(AnswerModelExtended))]
        ...
        [HttpGet("/Answers", Name = nameof(GetAll))]
        ...
        public async Task<IActionResult> PostAnswer([FromBody] AnswerCreateModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (item != null)
                {
                    return CreatedAtRoute(nameof(Get), item, item.UserId);
                }
                return Conflict();
            }
            return BadRequest();
